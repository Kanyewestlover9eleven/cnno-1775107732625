...
const basePath = '/cnno-1775107732625';
...
export default function Home() {
  ...
  const products = [{ n: 'Product 1', d: 'OG Rolls: Our original sweet rolls are a classic favorite, soft and fluffy on the inside, and golden brown on the outside, perfect for satisfying your sweet tooth.', icon: 'domain' }, { n: 'Product 2', d: 'Pistachio Rolls: Rich, nutty, and utterly delicious, our pistachio rolls add a unique twist to our classic recipe, with a hint of pistachio flavor in every bite.', icon: 'architecture' }, { n: 'Product 3', d: 'Chocolate Rolls: For all the chocolate lovers out there, our chocolate rolls are a dream come true, with a decadent, velvety chocolate filling wrapped in our signature sweet roll dough.', icon: 'chair' }, { n: 'Product 4', d: 'Baby Rolls: Our adorable baby rolls are the perfect treat for little ones (and let\'s be honest, adults too!), bite-sized and bursting with sweet, fluffy goodness.', icon: 'eco' }, { n: 'Product 5', d: 'Party Box: Whether you\'re celebrating a special occasion or just want to share the love, our party box is the perfect solution, featuring a selection of our signature sweet rolls in a variety of flavors.', icon: 'precision_manufacturing' }];
      ...
      <section id="about" className="py-24 bg-surface">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div><h4 className="font-bold text-primary">Mission</h4><p className="text-sm text-on-surface-variant">To craft high-quality, delicious sweet rolls that bring people together and make every day a little sweeter.</p></div>
